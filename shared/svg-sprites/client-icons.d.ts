 ...
 * Sprite source directory: G:\TeaSpeak\web\shared\img\client-icons
 * Sprite count: 222
 */
...
export enum ClientIcon {
  ...
  AvatarUpload = "client-avatar_upload",
  Away = "client-away",
  ...
  BookmarkEditName = "client-bookmark_edit_name",
  ...
  ClientInfoCountry = "client-client_info_country",
  ClientInfoForumAccount = "client-client_info_forum_account",
  ClientInfoOnlineTime = "client-client_info_online_time",
  ClientInfoStatus = "client-client_info_status",
  ClientInfoVersion = "client-client_info_version",
  ClientInfoVolume = "client-client_info_volume",
  ...
  DoubleArrow = "client-double_arrow",
  Down = "client-down",
  ...
  GroupDelete = "client-group_delete",
  GroupPermissionCopy = "client-group_permission_copy",
  GroupRename = "client-group_rename",
  ...
  ImagePreviewBrowse = "client-image_preview_browse",
  Info = "client-info",
  ...
  SettingsLoading = "client-settings_loading",
  ShareScreen = "client-share_screen",
  SimpleArrow = "client-simple_arrow",
