                    ...
                    identity.improve_level(target_level, threads, () => active, current_level => {
                        ...
                        if (success) {
                            identity.level().then(level => {
                                ...
                                createInfoModal(tr("Identity successfully improved"), formatMessage(tr("Identity successfully improved to level {}"), level)).open();
                            }).catch(error => {
    ...
    modal = createModal({
        ...
        body: () => {
            ...
            const import_identity = (data: string, ini: boolean) => {
                ...
                TeaSpeakIdentity.import_ts(data, ini).then(identity => {
